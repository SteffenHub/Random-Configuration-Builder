...
public class AllesZufaellig extends AutoBauer {
     ...
     */
    public AllesZufaellig(int anzahlZuErzeugendeModelle, ArrayList<int[]> cnfInt, int anzahlVariablen, double[] ebr, String cnfDateiName, boolean seed_set, long seed, String iRFileName) {
