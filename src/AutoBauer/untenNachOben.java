...
public class untenNachOben extends AutoBauer{
     ...
     */
    public untenNachOben(int anzahlZuErzeugendeModelle, ArrayList<int[]> cnfInt, int anzahlVariablen, double[] ebr, String cnfDateiName,int dtcount, boolean seed_set, long seed) {
